...
def parse():
    ...
    parser_jobrunner.add_argument("--local-first", action="store_true", help="already started tests are launched with a higher priority")
...
def main():
    ...
    if args.command=="compute":
        ...
        if (args.with_jobrunner):
            j=jobrunner.JobRunner(args.with_jobrunner, run_id, config, args.local_first)
            j.run()
